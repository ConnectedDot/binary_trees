...
At the end of this project, was able to undesrtand these questions to some good extents:
...
As much as this is functional, adviced to be used for educational purposes only.
